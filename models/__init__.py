...
contacts_chats_relationship = db.Table(
    "contacts_chats_relationship",
    db.Column(
        "contact_id", db.Integer, db.ForeignKey("contact.contact_id"), primary_key=True
    ),
...
class Message(db.Model):
    ...
    contact_id = db.Column(
        db.Integer, db.ForeignKey("contact.contact_id"), nullable=False
    )
